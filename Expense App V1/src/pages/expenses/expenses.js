...
var ExpensesPage = (function () {
    function ExpensesPage(navCtrl, navParams, http, alertCtrl, loadingCtrl, actionSheetCtrl) {
    ...
    ExpensesPage.prototype.load_expenses = function () {
        var _this = this;
    ...
    /*new expense */
    ExpensesPage.prototype.add_new = function () {
        this.navCtrl.push(NewexpensePage);
    };
    /*pull to refresh*/
    ExpensesPage.prototype.doRefresh = function (refresher) {
        var _this = this;
        var link = 'http://www.vconnect.ml/api/exp_manage/my_expenses';
        var data = JSON.stringify({ user_id: localStorage.getItem('user_id') });
        this.http.post(link, data)
    ...
    /*Action icons */
    ExpensesPage.prototype.presentActionSheet = function (exp_type, exp_id, time) {
        var _this = this;
